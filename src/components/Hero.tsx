        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <motion.button
                ...
                className="px-8 py-4 rounded-xl border border-border text-foreground font-semibold transition-all duration-300 hover:bg-secondary hover:border-primary/50"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                View Our Work
          ...
          >
            ...
            >
              ...
              {/* Floating elements */}
              <motion.div
                className="absolute -top-8 -right-8 glass-card p-4 glow-orange"
                animate={{ y: [0, -10, 0] }}
              ...
              <motion.div
                className="absolute -bottom-4 -left-12 glass-card p-4"
                animate={{ y: [0, 10, 0] }}
